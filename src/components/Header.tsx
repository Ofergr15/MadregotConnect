...
import { Activity, Calendar, Users, Layers, Clock, ClipboardList, User, LogOut, Settings, X, Route, Trophy, MessageSquare, Watch, Bell, Dumbbell, GraduationCap, Eye, UserCheck, ClipboardCheck, BarChart3 } from 'lucide-react';
