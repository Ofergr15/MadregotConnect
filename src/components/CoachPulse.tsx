...
export function CoachPulse() {
  ...
  return (
    <Card variant="solid" className="mb-4" dir="rtl">
      ...
      {celebrate.length > 0 && (
        <div>
          <div className="flex items-center gap-1.5 mb-2"><PartyPopper className="h-3.5 w-3.5 text-accent-600" /><span className="text-xs font-bold text-accent-900">לחגוג 🎉</span></div>
          <div className="space-y-1.5">
